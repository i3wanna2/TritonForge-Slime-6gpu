...
def init_process_group(
    ...
    # Do NOT use str(torch.__version__) >= "2.6" — that breaks on 2.10+ (lexicographic).
    import inspect
    ...
    if pg_options_param_name is not None:
        helper_kwargs[pg_options_param_name] = pg_options
